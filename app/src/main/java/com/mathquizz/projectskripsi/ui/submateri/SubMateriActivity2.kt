...
@AndroidEntryPoint
class SubMateriActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("ActivityCheck", "SubMateriActivity2 dipanggil")   //Cek Pemanggilan
    ...
    private fun submateriSetup() {
        ...
        binding.rvSubMateri.apply {
            layoutManager = LinearLayoutManager(this@SubMateriActivity2, LinearLayoutManager.VERTICAL, false)
            ...
            viewModel.subMateriList.collectLatest { result ->
                when (result) {
                    ...
                    is Resource.Error -> {
                        ...
                        Toast.makeText(this@SubMateriActivity2, result.message, Toast.LENGTH_SHORT).show()
                    }
                    else -> Unit
                }
            }
