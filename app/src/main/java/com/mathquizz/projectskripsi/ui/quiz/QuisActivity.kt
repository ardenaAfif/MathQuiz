...
import com.mathquizz.projectskripsi.ui.resultquis.ResultQuisActivity
...
class QuisActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("ActivityCheck", "QuisActivity dipanggil")   //Cek Pemanggilan
    ...
    private fun onQuizEnd() {
        ...
        lifecycleScope.launch {
            try {
                viewModel.updateProgressBasedOnQuiz(userId, correctAnswers)
                val intent = Intent(this@QuisActivity, ResultQuisActivity::class.java).apply {
