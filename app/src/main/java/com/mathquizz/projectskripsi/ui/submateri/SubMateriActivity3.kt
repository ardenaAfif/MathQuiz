...
@AndroidEntryPoint
class SubMateriActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("ActivityCheck", "SubMateriActivity3 dipanggil")   //Cek Pemanggilan
    ...
    private fun submateriSetup() {
        ...
        binding.rvSubMateri.apply {
            layoutManager = LinearLayoutManager(this@SubMateriActivity3, LinearLayoutManager.VERTICAL, false)
            ...
            viewModel.subMateriList.collectLatest { result ->
                when (result) {
                    ...
                    is Resource.Error -> {
                        ...
                        Toast.makeText(this@SubMateriActivity3, result.message, Toast.LENGTH_SHORT).show()
                    }
                    else -> Unit
                }
            }
